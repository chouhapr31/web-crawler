...
public class CrawlerTest1 {
	...
	public static void main(String[] args) {
		...
		for (Map<String, Set<String>> set : values) {
			...
			Iterator i = setOfUniqueLinks.iterator();
			Set<String> setOfUniqueLinks1 = new HashSet<String>();
			while (i.hasNext()) {
				String link = (String) i.next();
				// System.out.println(link);
				HashMap<String, Map<String, Set<String>>> mapInternal = c.getLinksDetail(link);
				...
				for (Map<String, Set<String>> set1 : valuesInternal) {
					...
					Iterator setOfUniqueLinksinternalLinksIterator = setOfUniqueLinks1.iterator();
